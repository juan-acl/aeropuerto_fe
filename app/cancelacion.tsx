...
import { VUELOS, CANCELACIONES, HOTELES, RESERVAS } from '@/services/mockData';

function calcPenalizacion(precio: number, diasAnticipacion: number): number {
  if (diasAnticipacion >= 7) return 0;
  if (diasAnticipacion >= 3) return precio * 0.10;
  if (diasAnticipacion >= 1) return precio * 0.25;
  return precio * 0.50;
}
