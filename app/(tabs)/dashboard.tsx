...
import {
  VUELOS, ALERTAS_DATA, EMPLEADOS, INGRESOS_DATA,
  GASTOS_DATA, PROGRAMAS_LEALTAD, HOTELES, CANCELACIONES,
    ...
    <SafeAreaView style={s.container}>
      ...
      >
        <View style={s.quickRow}>
          {[
            { icon: '✈️', label: 'Reservar',   path: '/reservar'          },
...
function DashboardAdmin() {
  ...
  const ADMIN_LINKS = [
    ...
    { icon: '📊', label: 'Marketing', path: '/modules/mod25-marketing'   },
    { icon: '🌿', label: 'Ambiental', path: '/modules/mod23-ambiental'   },
  ];
