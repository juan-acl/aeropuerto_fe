...
import {
  EMPLEADOS, CUENTAS_BANCARIAS, PRESUPUESTOS_DATA,
  ORDENES_COMPRA, PROHIBICIONES, ALERTAS_DATA, INCIDENTES_SEG,
              ...
              <FlatList
                ...
                renderItem={({ item: u }) => (
                  <TouchableOpacity style={[sd.userCard, u.estado === 'BLOQUEADO' && sd.userCardBlocked]}
                    ...
                    <View style={[sd.userAvatar, { backgroundColor: ROLES_DISPONIBLES.find(r => r.value === u.rol)?.color + '20' ?? C.infoBg }]}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                          ...
                          <View style={{ padding: 16, gap: 12 }}>
                            ...
                            <View style={sd.sheetCard}>
                              ...
                              <View style={[sd.rolBox, { borderColor: rolCfg?.color + '40' ?? C.border, backgroundColor: rolCfg?.color + '0C' ?? C.bg }]}>
