...
function InnerLayout() {
  ...
  return (
    <Stack key={sessionKey} screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="notificaciones" options={{ headerShown: false, animation: Platform.OS === 'ios' ? 'default' : 'fade' }} />
      <Stack.Screen name="buscar"         options={{ headerShown: false, animation: Platform.OS === 'ios' ? 'slide_from_bottom' : 'fade' }} />
      <Stack.Screen name="preferencias"    options={{ headerShown: false, animation: Platform.OS === 'ios' ? 'default' : 'fade' }} />
      <Stack.Screen name="cliente-home"   options={{ headerShown: false }} />
      <Stack.Screen name="analytics"      options={{ headerShown: false, animation: Platform.OS === 'ios' ? 'default' : 'fade' }} />
    </Stack>
  );
}
